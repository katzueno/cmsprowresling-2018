...
<html xmlns="//www.w3.org/1999/xhtml" xml:lang="<?php echo Localization::activeLanguage() ?>" lang="<?php echo Localization::activeLanguage() ?>">
<head>
<?php
...
<div id="wrap">
	...
	<div id="hd_sp" class="clearfix">
		<ul class="other_link_sp clearfix">
				...
				<li class="other5"><a href="//www.tsuda.ac.jp/en/">English</a></li>
		...
		<div class="hd_ct clearfix">
			...
			<div class="hd_other">
				<div class="other_box clearfix">
					...
					<p class="btn_en"><a href="//www.tsuda.ac.jp/en/">English</a></p>
				</div>
			...
			<li id="gnav1"><a href="/about/index.html">大学案内</a>
				...
				<div class="sub clearfix">
					<ul class="large_link clearfix">
										...
										<li class="arw_small"><a href="//pg.tsuda.ac.jp/" target="_blank">ウェブマガジン plum garden<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									</ul>
				</div>
			...
			<li id="gnav2"><a href="/education/index.html">教育の特色</a>
				...
				<div class="sub clearfix">
					<ul class="large_link clearfix">
										...
										<li><a href="//lib.tsuda.ac.jp/?contents_id=JBlMmxEsPzeN" target="_blank">図書館・AVライブラリー<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									
										<li><a href="//offcampus.tsuda.ac.jp/" target="_blank">学外学修センター<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									</ul><ul class="small_link clearfix">
										...
										<li class="arw_small"><a href="//twc.tsuda.ac.jp/" target="_blank">ライティングセンター<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									
										<li class="arw_small"><a href="//edu.tsuda.ac.jp/cmccl/" target="_blank">ソーシャル・メディア・センター<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
			...
			<li id="gnav8"><a href="/open-college/index.html">開かれた大学</a>
				...
				<div class="sub clearfix">
					<ul class="large_link clearfix">
										...
										<li><a href="//tou.tsuda.ac.jp/" target="_blank">津田塾大学オープンユニバーシティ<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									
										<li><a href="//koryukan.tsuda.ac.jp/?contents_id=jRbNU7afTtY9" target="_blank">津田梅子記念交流館<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									
										<li><a href="//twc.tsuda.ac.jp/event/index.html" target="_blank">ライティングセンター講演会<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									
										<li><a href="//lib.tsuda.ac.jp/DigitalArchive/exhibition.html?contents_id=YybOk3dWJJjv" target="_blank">津田梅子資料室企画展<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
									</ul><ul class="small_link clearfix">
										...
										<li class="arw_small"><a href="//tac.lekumo.biz/tac/" target="_blank">TAC公開プログラム（TACニュース）<img src="/images/ico_blank.gif" width="14" height="12" alt="外部リンク" /></a></li>
					...
					<div class="container">
						...
						<div class="news_area">
							<div class="digest">
								...
								<div class="btn">
									<a href="//kouhou.tsuda.ac.jp/strengths/" target="_blank">
				...
				<div class="sub_section word">
					<div class="container">
						...
						<ul class="word_list">
								...
								<li><a href="//offcampus.tsuda.ac.jp/"><span class="cell"><span class="text">学外学修</span></span></a><span class="bg" style="background-image: url(/prospect/hak1k3000000gxks-img/keyword3.jpg);"></span></li>
...
津田塾オフィシャルウェブマガジン</p>
						...
						<div class="btn">
							<a href="//pg.tsuda.ac.jp/" target="_blank">
								<b class="click"><span>CLICK!</span></b>
...
<script type="text/javascript" src="/js/prospect-min.js"></script>
</body>
</html>
